...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir(projectPath + "/book-service" +  "/src/main/java");
        //Author设置作者
        globalConfig.setAuthor("yuhan");
        //是否覆盖文件
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/ebook?characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false");
